...
<template>
  <StudentPanelBorder>
    ...
    <div class="academic-growth">
      <div class="kpi-row">
        <div class="kpi-card primary clickable" @click="goGpaDetail">
        ...
        <div class="kpi-card clickable" @click="goCreditProgress">
...
.kpi-card {
  ...
  &.clickable {
    ...
    &:hover {
      ...
      box-shadow: 0 0 16px rgba(0, 212, 255, 0.18), inset 0 0 14px rgba(0, 212, 255, 0.06);
