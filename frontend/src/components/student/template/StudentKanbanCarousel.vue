        ...
        >
            <article class="development-card development-card--academic">
              ...
              <div class="academic-body">
                <StuHint tip="平均学分绩点（满分约 4.0）。" class="academic-gpa-wrap">
                  <div class="gpa-gauge">
...
.development-card--graduation .development-metrics {
  ...
  strong {
    ...
    &.is-safe { color: #55e995; font-family: var(--student-font-body); font-size: var(--fs-title); }
    &.is-text { color: #dff4ff; font-family: var(--student-font-body); font-size: 17px; }
...
.quality-body {
  display: grid;
  grid-template-rows: 50px minmax(80px, 1fr) 32px;
  gap: 5px;
  min-height: 0;
  overflow: hidden;
}
...
.academic-body {
  ...
  grid-template-rows: minmax(92px, 1fr) auto 34px;
  gap: 6px 12px;
  flex: 1 1 auto;
  min-height: 0;
...
.gpa-gauge {
  ...
  svg { width: 96px; height: 96px; transform: rotate(-90deg); }
  ...
  &__text {
    ...
    span { color: #8eb8d8; font-size: 12px; font-weight: 700; }
  }
}
...
.credit-bars {
  ...
  &__row {
    ...
    span { color: #9ecae8; font-size: 14px; font-weight: 600; }
    i {
      height: 12px;
      overflow: hidden;
      border-radius: 99px;
  ...
  &__row:nth-child(1) i b { background: linear-gradient(90deg, #1ed6ff, #4cc9f0); }
  &__row:nth-child(2) i b { background: linear-gradient(90deg, #43e7af, #67e8a3); }
  &__row:nth-child(3) i b { background: linear-gradient(90deg, #e8c878, #facc15); }
}
...
.thesis-steps {
  ...
  > span { color: #b6e4ff; font-size: var(--fs-label); font-weight: 700; }
