...
const pieOption = computed<EChartsOption>(() => ({
  ...
  legend: {
    ...
    itemHeight: 9,
    itemGap: 10,
    textStyle: { color: '#d8efff', fontSize: 11, fontWeight: 500 },
  },
  series: [{
    type: 'pie',
    radius: ['42%', '62%'],
...
const regionOption = computed<EChartsOption>(() => {
  ...
  return {
    ...
    yAxis: {
      ...
      axisLabel: { color: '#e8f7ff', fontSize: 12, fontWeight: 500, align: 'left', margin: GRID_LEFT - 6 },
    ...
    series: [{
      ...
      barWidth: 8,
      label: { show: true, position: 'right', distance: 6, formatter: '{c}%', color: '#f4fbff', fontSize: 12, fontWeight: 700 },
      itemStyle: {
        color: {
