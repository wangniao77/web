    ...
    <template v-else-if="data">
      ...
      <template v-if="currentTab === 'overview'">
        <div class="resource-summary">
          <div class="resource-summary__card" @click="scrollToSection('enrolled')">
            ...
            <div class="resource-summary__info">
              <span class="resource-summary__label">在校生</span>
        ...
        <section id="enrolled" class="resource-section" :class="{ 'resource-section--active': activeSection === 'enrolled' }">
          <h2 class="resource-section__title"><span class="resource-section__title-icon">👥</span>在校生规模<span class="resource-section__badge">{{ data.summary.enrolledUndergrad }} 人</span></h2>
            ...
            <div class="resource-card">
              ...
              <ul class="resource-list">
                <li class="resource-list__item">
                  <span class="resource-list__label">本科在校</span>
                  <div class="resource-list__bar-track"><div class="resource-list__bar-fill" style="width: 100%" /></div>
                  <span class="resource-list__value">{{ data.summary.enrolledUndergrad }} 人</span>
                </li>
                <li class="resource-list__item">
                  <span class="resource-list__label">研究生</span>
                  <div class="resource-list__bar-track"><div class="resource-list__bar-fill resource-list__bar-fill--phd" :style="{ width: `${Math.min(100, (data.summary.enrolledGraduate / data.summary.enrolledUndergrad) * 100 * 4)}%` }" /></div>
                  <span class="resource-list__value">{{ data.summary.enrolledGraduate }} 人</span>
                </li>
              </ul>
            </div>
            <div class="resource-card">
              ...
              <div class="resource-card__insight resource-card__insight--large">
                ...
                <p>
                  研究生占比约
                  <strong>{{ ((data.summary.enrolledGraduate / (data.summary.enrolledUndergrad + data.summary.enrolledGraduate)) * 100).toFixed(1) }}%</strong>。
                  建议持续扩大优质生源与本硕贯通培养，提升高层次人才供给。
                </p>
              </div>
            </div>
          </div>
      ...
      <template v-else-if="currentTab === 'high-potential'">
        ...
        <section class="resource-section resource-section--active">
          ...
          <div class="resource-card">
            ...
            <div class="resource-card__insight">
              <span class="resource-card__insight-icon">💡</span>
              <p>当前名单：<strong>{{ selectedHpName }}</strong>。点击柱条切换；也可点顶部摘要卡。</p>
            </div>
          </div>
