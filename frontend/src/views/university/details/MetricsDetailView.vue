...
.metrics-section h3 { font-size: 20px; color: #f3f8ff; margin-bottom: 10px; padding-bottom: 6px; border-bottom: 1px solid rgba(85, 168, 255, 0.12); }
...
.metric-card {
  ...
  h4 { font-size: 18px; color: #55dfff; margin-bottom: 8px; }
  p { font-size: 16px; color: rgba(174, 198, 230, 0.78); line-height: 1.55; margin-bottom: 4px; }
