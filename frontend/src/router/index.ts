...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      component: () => import('@/views/student/StudentShellView.vue'),
      children: [
        {
          path: '',
          name: 'student',
        ...
        {
          path: 'career-path/postgrad',
          redirect: (to) => ({
            name: 'student-career-development',
            query: { ...to.query, tab: 'graduate' },
          }),
        },
        {
          path: 'career-path/job',
          redirect: (to) => ({
            name: 'student-career-development',
            query: { ...to.query, tab: 'employment' },
          }),
        },
        {
          path: 'career-path/civil',
          redirect: (to) => ({
            name: 'student-career-development',
            query: { ...to.query, tab: 'civil' },
          }),
        },
        {
