...
export function mockStudentDevQuality(dimension: DevQualityDimension = 'major'): StudentDevQualityDTO {
  return {
    ...
    highPotential: {
      ...
      structure: [
        { key: 'competition', label: '竞赛高潜', count: 156 },
        { key: 'academic', label: '学业高潜', count: 238 },
        { key: 'research', label: '科研创新', count: 126 },
        { key: 'practice', label: '实践高潜', count: 184 },
      ],
    ...
    outcomeConversion: [
      { key: 'research', label: '科研成果转化率', rate: 61.3 },
      { key: 'competition', label: '竞赛成果转化率', rate: 72.8 },
      { key: 'practice', label: '实践成果转化率', rate: 58.6 },
    ],
