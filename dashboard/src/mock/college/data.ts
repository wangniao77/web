...
export const mockEvaluationOverview: EvaluationOverviewDTO = {
  developmentIndex: 87.6,
  dimensions: [
    { name: '人才培养', score: 94.2 },
    { name: '师资队伍', score: 88.5 },
    { name: '科学研究', score: 86.3 },
    { name: '社会服务', score: 85.8 },
    { name: '内部治理', score: 83.2 },
  ],
  suggestions: [
    '加强青年博士引进力度',
    '提升横向科研经费占比',
