...
<template>
  <header class="header">
    ...
    <div class="header-center">
      <h1 class="title">
        <span class="title-text">大数据与人工智能学院发展与治理驾驶舱</span>
      </h1>
...
.school-name { font-size: $college-fs-body; font-weight: 700; color: #f4f8ff; letter-spacing: 0; }
