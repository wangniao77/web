...
import type { HighPotentialModuleVM, HighPotentialOverviewVM } from '@/types/view/college/details'
...
onMounted(async () => {
  loading.value = true
  try {
    overview.value = await collegeDetailService.fetchHighPotentialOverview()
  } finally {
    loading.value = false
  }
})
