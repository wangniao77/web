...
const Caibao3D = defineAsyncComponent(() => import('@/components/mascot/Caibao3D.vue'))
...
const topHighlights = computed(() => props.highlights.slice(0, HIGHLIGHT_LIMIT))
const extraHighlights = computed(() => Math.max(0, props.highlights.length - HIGHLIGHT_LIMIT))
</script>
      ...
      <div class="insight-row">
        <div class="section">
          <span class="section-label">
            成长亮点
            <em v-if="extraHighlights" class="more-count">+{{ extraHighlights }}</em>
          </span>
          <ul class="highlight-list">
            <li v-for="item in topHighlights" :key="item.id">
              <span class="dot gold" />
              <div class="content">
