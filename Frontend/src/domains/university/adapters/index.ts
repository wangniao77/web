...
import { RISK_LEVEL_MAP, TASK_STATUS_TO_RISK } from '@/domains/university/constants/risk'
import {
  EVENT_CATEGORY_LABELS,
  EVENT_STATUS_LABELS,
} from '@/domains/university/constants/labels'
import { NEWS_TAG_LABELS } from '@/domains/university/constants/datav-theme'
import type {
  KeyTaskDTO,
  SchoolEventDTO,
...
export type { UniversityScope } from '@/core/types/common'
