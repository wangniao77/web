...
<template>
  <section ref="panelRef" class="panel">
    ...
    <header class="panel-header">
      ...
      <RouterLink v-if="showMore && moreTo" class="panel-more" :to="moreTo">更多 &rsaquo;</RouterLink>
      <span v-else-if="showMore" class="panel-more panel-more--disabled">更多 &rsaquo;</span>
    </header>
